import "../css/ShipControl.scss";
import abducted from "../assets/abducted.png";
...
export const ShipControl = ({
  ...
  return (
    <div className={`controls ${isOnStart ? "animated" : ""}`}>
      ...
      <section id="header">
        <div className="wrap">
          <div className="ui-inner-border">
            <button disabled={isDisabled} onClick={onClick}>
              <span className="border" />
              <span className="button-content">
                <img src={abducted} alt="abducted" />
                <p>CATCH LAB HUMAN</p>
              </span>
            </button>
          </div>
          <div className="ui-tics">
            <i className="tic"></i>
          </div>
          <div className="ui-grid">
            <div className="ui-box">
              <h1 className="title" slot="content">
                {name}
              </h1>
              <div className="ui-fx">
                <div className="ui-inner-border l"></div>
                <div className="ui-inner-border r"></div>
                <span className="ui-corner"></span>
                <div className="ui-batts">
                  <span className="batt"></span>
                </div>
              </div>
            </div>
